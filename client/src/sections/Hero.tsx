  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="font-economica mt-10 font-bold text-xl py-1 px-5 rounded-xl z-10 text-gray-200 bg-transparent border-4 border-red-900 hover:border-red-900 hover:bg-red-900"
      >
        Book Now
      </button>
    </div>
